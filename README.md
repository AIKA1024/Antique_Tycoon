...
> [!WARNING]
> **本项目仅供学习与技术交流使用，为非商业性质的个人作品，严禁用于任何商业用途。**
> 项目中使用的纹理、音效、角色形象等素材来源于《Minecraft》（我的世界），
> 版权归 **Mojang Studios / Microsoft** 所有。本项目与其没有任何关联，也未获得其授权或赞助。
> 完整说明见文末[免责声明](#免责声明)。
...
<p align="center">
  <img src="ImageAsset/%E6%8B%9B%E5%8B%9F%E4%BC%99%E8%AE%A1.png" alt="招募伙计" width="800">
</p>
...
- 项目中使用的纹理、音效、BGM、角色形象（史蒂夫、苦力怕、僵尸等）等美术与音频素材，均来源于游戏《Minecraft》（我的世界），其版权归 **Mojang Studios / Microsoft** 所有，本项目不对这些素材主张任何权利。
- 本项目与 Mojang Studios、Microsoft 及其关联公司**没有任何关系**，也未获得其授权、认可或赞助，属于粉丝性质的学习作品。
- 本项目不包含、也不分发《Minecraft》游戏本体及相关官方资源包，请自行通过官方渠道获取正版游戏。
- 请勿将本项目用于商业盈利，也请勿单独二次分发其中的素材。
- 若权利方认为本项目存在侵权，请通过 Issue 联系作者，我会在第一时间删除相关内容或下架本仓库。

**如果你是下载 / 克隆本项目的使用者**：请将其仅作为技术学习参考，自行承担使用后果。

## 许可

代码部分目前尚未添加开源许可证（默认保留所有权利）。如需在自己的项目中复用代码，请先联系作者。
素材部分不适用任何开源许可，一切权利归原作者所有。
